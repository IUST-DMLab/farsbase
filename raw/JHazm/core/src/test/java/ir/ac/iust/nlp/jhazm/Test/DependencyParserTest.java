...
public class DependencyParserTest {
  ...
  public void parseTest()
    ...
    assertEquals("Failed to stem of '" + Arrays.toString(input) + "'", expected, actual);
    ...
    Iterator<ConcurrentDependencyGraph> iterator = parser.rawParses(Collections.singletonList(inputSentence)).iterator();
    graph = iterator.next();
