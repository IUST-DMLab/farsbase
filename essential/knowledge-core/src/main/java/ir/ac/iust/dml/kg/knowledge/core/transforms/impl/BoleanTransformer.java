...
@Transformer(value = "boolean", description = "تبدیل به بولین")
public class BoleanTransformer implements ITransformer {

  @Override
  public TypedValue transform(String value, String lang, ValueType type, String unit) throws TransformException {
    try {
      return new TypedValue(ValueType.Boolean, Boolean.parseBoolean(value) + "", null);
    } catch (Throwable th) {
